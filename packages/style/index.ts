  ...
  board: {
    ...
    cell: {
      locked: {
        ...
        dflt: 'size-cell m-gap float-left grid justify-center content-center rounded-sm text-4xl text-black dark:text-white bg-purple-300 dark:bg-purple-800',
      },
      unlocked: {
        invalid:
        ...
        dflt: 'size-cell m-gap float-left grid justify-center content-center rounded-sm text-4xl text-purple-600 dark:text-purple-300 bg-purple-300 dark:bg-purple-800',
      },
    },
  },
  hint: {
