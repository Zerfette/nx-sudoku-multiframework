...
import { Eq as bEq, MonoidAll, MonoidAny } from 'fp-ts/boolean'
...
export const lensSatisfies: LensSatisfies = (
  lens,
  predicate
...
export const optionalSatisfies: OptionalSatisfies = (
  optional,
  predicate
...
export const optionalEq: OptionalEq =
  (optional, value) => (eq) =>
...
export const when: When = (predicate, fn) =>
